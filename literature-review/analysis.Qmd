  ...
  ggplot2::theme_minimal(base_family = "news") +
    ggplot2::theme(
      ...
      plot.subtitle = ggplot2::element_text(size = ggplot2::rel(1.1),
                                            hjust = 0.5),
      axis.text.x = ggplot2::element_text(face = "plain", size = 20),
      axis.title.x = ggplot2::element_text(face = "plain", size = 21),
      axis.title.y = ggplot2::element_text(face = "plain", size = 21),
