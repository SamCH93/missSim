...
For the first revision, we change the first and last part of the plot to show absolut numbers instead of proportions, and add the total number of studies as a label: 
```{r}
...
p_c <- cowplot::plot_grid(q1_plot_rev1, 
